...
conan_package_library_targets("${cxxopts_LIBS_RELEASE}"    # libraries
                              ...
                              "${cxxopts_BIN_DIRS_RELEASE}" # package_bindir
                              "${cxxopts_LIBRARY_TYPE_RELEASE}"
                              "${cxxopts_IS_HOST_WINDOWS_RELEASE}"
                              cxxopts_DEPS_TARGET
                              cxxopts_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "cxxopts"    # package_name
                              "${cxxopts_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET cxxopts::cxxopts
                 ...
                 $<$<CONFIG:Release>:${cxxopts_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET cxxopts::cxxopts
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${cxxopts_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET cxxopts::cxxopts
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${cxxopts_LIB_DIRS_RELEASE}>)
    set_property(TARGET cxxopts::cxxopts
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${cxxopts_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET cxxopts::cxxopts
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${cxxopts_COMPILE_OPTIONS_RELEASE}>)
