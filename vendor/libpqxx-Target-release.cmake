...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT libpqxx::pqxx #############
        ...
        set_property(TARGET libpqxx::pqxx APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libpqxx_libpqxx_pqxx_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libpqxx::pqxx APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libpqxx_libpqxx_pqxx_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libpqxx::pqxx APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libpqxx_libpqxx_pqxx_LIB_DIRS_RELEASE}>)
        set_property(TARGET libpqxx::pqxx APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libpqxx_libpqxx_pqxx_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libpqxx::pqxx APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libpqxx_libpqxx_pqxx_COMPILE_OPTIONS_RELEASE}>)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET libpqxx::pqxx APPEND PROPERTY INTERFACE_LINK_LIBRARIES libpqxx::pqxx)
